...
process MERGEDEFACEQASTEP3 {
    ...
    tuple val("${task.process}"), val('mergedefaceqastep3'), eval("mergedefaceqastep3 --version"), topic: versions, emit: versions_mergedefaceqastep3
