...
process SUMMARIZEDEFACEQASTEP3 {
    tag "$meta.id"
    ...
    tuple val("${task.process}"), val('summarizedefaceqastep3'), eval("summarizedefaceqastep3 --version"), topic: versions, emit: versions_summarizedefaceqastep3
