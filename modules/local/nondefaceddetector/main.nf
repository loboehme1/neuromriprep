...
process NONDEFACEDDETECTOR {
    ...
    tuple val("${task.process}"), val('nondefaceddetector'), eval("nondefaceddetector --version"), topic: versions, emit: versions_nondefaceddetector
